...
$\gamma = .5$ and $C = 10$ with a score of $0.59$. The scores given here are f1 measures.
...
\subsubsection{Mario Benchmark}
While it's not able to meet the standard of some of the other algorithms, it performs at levels well above chance.
